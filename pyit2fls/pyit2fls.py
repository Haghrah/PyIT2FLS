...
if __name__ == "__main__":
    ...
    domain = arange(start=-0.5, stop=1.5, step=0.01)
    t = time()
    
    #params = np.random.rand(8, 4)
    
    params = np.array([[0.00000000e+00, 0.00000000e+00, 1.06300276e-20, 6.90180084e-01],
       [1.07142857e-01, 1.07142857e-01, 1.06300276e-20, 6.90180084e-01],
       [2.14285714e-01, 2.14285714e-01, 1.06300276e-20, 6.90180084e-01],
       [3.21428571e-01, 3.21428571e-01, 1.06300276e-20, 6.90180084e-01],
       [4.28571429e-01, 4.28571429e-01, 1.06300276e-20, 6.90180084e-01],
       [5.35714286e-01, 5.35714286e-01, 1.06300276e-20, 6.90180084e-01],
       [6.42857143e-01, 6.42857143e-01, 1.06300276e-20, 6.90180084e-01],
       [7.50000000e-01, 7.50000000e-01, 1.06300276e-20, 6.90180084e-01],
       [8.57142857e-01, 8.57142857e-01, 1.06300276e-20, 6.53236823e-01],
       [9.64285714e-01, 9.64285714e-01, 1.06300276e-20, 5.66330019e-01],
       [1.07142857e+00, 1.07142857e+00, 1.06300276e-20, 4.80973128e-01],
       [1.17857143e+00, 1.17857143e+00, 1.06300276e-20, 4.00151409e-01],
       [1.28571429e+00, 1.28571429e+00, 1.06300276e-20, 3.26122073e-01],
       [1.39285714e+00, 1.39285714e+00, 1.06300276e-20, 2.60368443e-01],
       [1.50000000e+00, 1.50000000e+00, 1.06300276e-20, 2.03633302e-01]])
    
    params = np.load("aa.npy")
    
    #params.sort(axis=1)
    print(EKM_algorithm(params))
    #print(time() - t)
